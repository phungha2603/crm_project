                                    ...
                                    <tbody>
                                    	<c:forEach var="item" items="${listUser}">
                                    		<tr>
	                                            ...
	                                            <td>
	                                                <a href="<c:url value="/user-edit?userId=${item.id}" />" class="btn btn-sm btn-primary btn-edit" id-user="${item.id}">Sửa</a>
	                                                <a href="#" class="btn btn-sm btn-danger btn-xoa" id-user="${item.id}">Xóa</a>
	                                                <a href="#" class="btn btn-sm btn-info" id-user="${item.id}">Xem</a>
	                                            </td>
                                        	</tr>
                                    	</c:forEach>
