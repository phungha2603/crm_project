...
<body>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<c:url value="/groupwork-table"/>" class="waves-effect"><i class="fa fa-table fa-fw"
                                aria-hidden="true"></i><span class="hide-menu">Dự án</span></a>
                    </li>
                    <li>
                        <a href="<c:url value="/task-table" />" class="waves-effect"><i class="fa fa-table fa-fw"
                            ...
                            <form action="<c:url value= '/groupwork-edit'/>" method="post" class="form-horizontal form-material">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="hidden" name="id" value="${project.id}"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày bắt đầu</label>
                                    <div class="col-md-12">
                                        <input type="date" placeholder="${project.startDate}" name="startDate" value="${project.startDate}" min="1950-01-01" max="2100-12-31"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày kết thúc</label>
                                    <div class="col-md-12">
                                        <input type="date" placeholder="${project.endDate}" name="endDate" value="${project.endDate}" min="1950-01-01" max="2100-12-31"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-success">Lưu lại</button>
                                        <a href="<c:url value="/groupwork-table"/>" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <script type="text/javascript" src="js/groupwork-edit.js"></script>
</body>
